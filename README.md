...
import { Briefcase, Play, RotateCcw, Mic, Clock, CheckCircle, History, TrendingUp, Award, Volume2, VolumeX, Square } from 'lucide-react';
...
export default function MockInterviewApp() {
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      await window.storage.set(`user-${signupEmail}`, JSON.stringify(newUser), false);
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    <div className="text-center">
                      ...
                      <div className="font-semibold text-gray-800">Text Mode</div>
                      <div className="text-xs text-gray-600 mt-1">Type your answers</div>
                    </div>
                  </button>
                  <button
                  ...
                  >
                    <div className="text-center">
                      ...
                      <div className="font-semibold text-gray-800">Voice Mode</div>
                      <div className="text-xs text-gray-600 mt-1">Speak your answers</div>
                    </div>
                  </button>
                </div>
              </div>
            ...
            <div className="bg-indigo-50 border-l-4 border-indigo-600 p-6 mb-6 rounded">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  {interviewMode === 'voice' && isSpeaking && (
                    <div className="mt-2 flex items-center gap-2 text-indigo-600">
                      <div className="flex gap-1">
                        <div className="w-1 h-4 bg-indigo-600 animate-pulse"></div>
                        <div className="w-1 h-4 bg-indigo-600 animate-pulse" style={{ animationDelay: '0.2s' }}></div>
                        <div className="w-1 h-4 bg-indigo-600 animate-pulse" style={{ animationDelay: '0.4s' }}></div>
                      </div>
                ...
                <>
                  ...
                  {userAnswer && (
                    <div className="bg-gray-50 border border-gray-300 rounded-lg p-4 mb-4">
                      <p className="text-sm font-medium text-gray-700 mb-2">Transcribed Answer:</p>
                  ...
                  <div className="space-y-3">
                    <div className="bg-yellow-50 border border-yellow-300 rounded-lg p-4 mb-4">
                      <p className="text-sm text-yellow-800">
                        <strong>Note:</strong> Voice mode requires microphone permissions and works best in Chrome/Edge browsers.
                      </p>
                    </div>
                    ...
                    {isRecording && (
                      <div className="space-y-3">
                        <div className="bg-red-50 border-2 border-red-500 rounded-lg p-6 text-center">
                          ...
                          <p className="text-lg font-semibold text-red-900 mb-2">Recording...</p>
                          <p className="text-sm text-red-700">Speak your answer clearly</p>
                          {userAnswer && (
                            <div className="mt-4 bg-white p-3 rounded text-left">
